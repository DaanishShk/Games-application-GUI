...
def developers():
    messagebox.showinfo('Developers', 'Daanish Shaikh\t\t\t- UI\nhttps://github.com/DaanishShk\n\n'
                                    'Member1\t\t\t- Street Racer\nMember2\t\t\t- Snake\nMember3'
...
main.wm_iconbitmap('./images/Controller.ico')
main.resizable(0, 0)
...
image1 = PhotoImage(file='./images/Car Race.png')
...
image2=PhotoImage(file='./images/Pac.png')
...
image3=PhotoImage(file='./images/Falling.png')
...
image4=PhotoImage(file='./images/Tiles.png')
